...
abstract class AppLocalizations {
  ...
  /// No description provided for @importEpubSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Choose a book file from this device'**
  String get importEpubSubtitle;
  ...
  /// No description provided for @browseProjectGutenberg.
  ///
  /// In en, this message translates to:
  /// **'Browse Project Gutenberg'**
  String get browseProjectGutenberg;
  ...
  /// No description provided for @howToUseNalori.
  ///
  /// In en, this message translates to:
  /// **'How to use Nalori'**
  String get howToUseNalori;
  ...
  /// No description provided for @enhanceBookDetailsOnline.
  ///
  /// In en, this message translates to:
  /// **'Enhance book details online'**
  String get enhanceBookDetailsOnline;

  /// No description provided for @enhanceBookDetailsOnlineSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @personalLibraryTagline.
  ///
  /// In en, this message translates to:
  /// **'Your personal library'**
  String get personalLibraryTagline;

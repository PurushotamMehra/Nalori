...
final class LazyStableCardBody {
  LazyStableCardBody._(this.canonicalEncoding, this.signature);
  ...
  ReaderCardIdentity get identity => ReaderCardIdentity.fromJson(
    Map<String, Object?>.from(toJson()['identity']! as Map),
  );

  List<LazyStableSourceSlice> get sourceSlices => List.unmodifiable([
    for (final slice in toJson()['slices']! as List)
      LazyStableSourceSlice.fromJson(Map<String, Object?>.from(slice as Map)),
  ]);
  ...
  factory LazyStableCardBody.fromJson(Map<String, Object?> json) {
    ...
    return LazyStableCardBody._(encoded, json['digest']! as String);
  }

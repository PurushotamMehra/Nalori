              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Your note',
                    hintText: 'Capture the thought, question, or insight here.',
                    helperText: 'Press the keyboard done button or Save Note.',
                    alignLabelWithHint: true,
                    labelStyle: TextStyle(color: readerTheme.muted),
                    hintStyle: TextStyle(
                      color: readerTheme.muted.withValues(alpha: 0.72),
                    ),
                    helperStyle: TextStyle(
                      color: readerTheme.muted.withValues(alpha: 0.82),
                    ),
                    counterStyle: TextStyle(color: readerTheme.muted),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(18),
                      borderSide: BorderSide(color: readerTheme.divider),
                    ),
                    ...
                    Expanded(
                      child: FilledButton.icon(
                        ...
                        style: FilledButton.styleFrom(
                          ...
                          foregroundColor: _foregroundFor(widget.accentColor),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(16),
                          ),
                        ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(14),
                        border: Border.all(
                          color: highlight.color.withValues(alpha: 0.34),
                        ),
                      ),
                      child: Text(
                        '"$previewText"',
